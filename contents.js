...
changeAds = () => {
    return '<div style="background: aliceblue;border-radius: 2px;padding: 1rem;text-align: center"><h1 style="text-align: center">Đây là nội dung quảng cáo facebook, <strong style="color: brown">đã bị xoá</strong></h1></div>';
}
